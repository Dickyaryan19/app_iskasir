            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td> <h6 class="mb-0 text-sm m-3">sepatu</h6> </td>
                      <td> <p class="text-xs text-secondary mb-0">3</p> </td>
                      <td> <p class="text-xs text-secondary mb-0">120.000</p> </td>
                      ...
                      <tr>
                      <td> <h6 class="mb-0 text-sm m-3">laptop</h6> </td>
                      <td> <p class="text-xs text-secondary mb-0">2</p> </td>
                      <td> <p class="text-xs text-secondary mb-0">4.000.000</p> </td>
                      <td class="align-middle text-center text-sm">
                        <a href="#" class="badge badge-sm bg-gradient-danger">
                          Hapus
                        </a>
                        <tr>
                        <td> <h6 class="mb-0 text-sm m-3">peralatan skena</h6> </td>
                      <td> <p class="text-xs text-secondary mb-0">3</p> </td>
                      <td> <p class="text-xs text-secondary mb-0">120.000</p> </td>
                      <td class="align-middle text-center text-sm">
                        <a href="#" class="badge badge-sm bg-gradient-danger">
